...
export default {
  ...
  methods: {
    fetchData() {
      ...
      page(this.listQuery.page, this.listQuery.limit, this.listQuery.type, this.listQuery.status, this.listQuery.name ? this.listQuery.name : undefined, this.listQuery.status, this.listQuery.code ? this.listQuery.code : undefined).then(response => {
        if (response.data) {
