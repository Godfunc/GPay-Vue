    ...
    >
      ...
      <el-table-column label="操作" align="center" width="135" fixed="right">
        <template slot-scope="scope">
          ...
          <el-button v-permission="'merchant:channelRisk:listByChannel'" type="text" style="color: #e6a23c;" @click="handleRisk(scope.row.id)">风控</el-button>
...
export default {
  ...
  methods: {
    ...
    handleRisk(id) {
      this.$refs.channelRisk.handleRisk(id)
    },
    createData() {
